    ...
    <body onload = "animacja.wczytaj(); blad.wykonaj(); data.zacznij()" class = "ruchome">
        ...
        <div class = "content">
            <form method = "post" action = "./scripts/wizyty.php">
                ...
                <input class = "button" type = "submit" value = "Odwołaj wybraną wizytę" name = "o" style = "margin-left: 16.66666666666666666666666666666666666666666666%; width: 66.666666666666666666666666666666666666666666666666666666666%;"/>
            </form>
        </div>
